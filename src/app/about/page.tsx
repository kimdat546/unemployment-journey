        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
              This is my real story of healing and growth through unemployment.
              Not the sanitized version you see on social media, but the
              authentic, messy, beautiful human experience of finding hope while
              everything feels uncertain.
            </p>
            <div className="mt-8 p-4 bg-white/50 backdrop-blur-sm rounded-2xl border border-green-200/30 max-w-2xl mx-auto">
              <p className="text-green-700 font-medium">
                🤗 If you&apos;re here, you&apos;re probably going through
                something similar. You&apos;re not alone, and your healing
                matters.
              </p>
            </div>
          </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <section className="healing-card rounded-2xl p-8 relative overflow-hidden">
                ...
                <div className="prose prose-lg text-gray-700 space-y-6 leading-relaxed">
                  <p>
                    I’m Claire. For years, I was a child of capitalism—working
                    from 8 a.m. until midnight, day after day, chasing endless
                    tasks that never seemed to end. I worked myself to
                    exhaustion, and yet, something always felt missing.
                  </p>
                  <p>
                    One quiet moment, I asked myself: Am I on the right path? Is
                    this the life I want to keep repeating until the end of
                    time? The answer shook me awake. Deep inside, I longed to
                    break free from the industrial loop and rediscover who I
                    truly am.
                  </p>
                  <p>
                    So, I chose to step away. I gave myself permission to pause,
                    to reflect, to breathe. This is not just unemployment—it’s a
                    conscious rebellion, a season of healing, and a journey back
                    to meaning.
                  </p>
                  <p>
                    What nobody tells you is how unemployment reshapes
                    everything: your self-worth, your rhythm, your sense of
                    purpose, even your faith in the future. Yet within this
                    challenge lies a doorway—to growth, to healing, to becoming
                    whole again.
                  </p>
                  <p>
                    I started writing because silence was heavy. But I know I’m
                    not alone. Millions of us are quietly navigating the same
                    path. This space is my way of breaking that silence, and
                    maybe, just maybe, offering you the courage to honor your
                    own journey too.
                  </p>
                  <p className="text-center text-2xl font-bold text-green-800">
                  ...
                  <p className="bg-green-50 p-4 rounded-lg border-l-4 border-green-400 italic">
                    ...
                    just an absence—it can also be a doorway to healing, growth,
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border border-green-200/30">
                    ...
                    <p className="text-green-700 text-sm leading-relaxed">
                      The difficult days, breakthrough moments, and everything
                      in between. Real healing isn&apos;t always pretty, and I
                      share it all.
                    </p>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl p-6 border border-yellow-200/30">
                    ...
                    <p className="text-yellow-700 text-sm leading-relaxed">
                      A safe space for others on similar journeys to connect,
              ...
              <section className="healing-card rounded-2xl p-8">
                ...
                <div className="mt-6 p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-green-200/30 text-center">
                  <p className="text-green-700 font-medium text-sm">
                    🌿 Progress isn&apos;t always linear, but every day is part
                    of my healing story
                  </p>
                </div>
              </section>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6 border border-blue-200/30">
                ...
                <p className="text-blue-700 text-sm mb-4 leading-relaxed">
                  Going through something similar? Want to share your healing
                  story? Or just need someone who truly understands?
                </p>
                <a
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6 border border-green-200/30 relative overflow-hidden">
                ...
                <p className="text-green-700 text-sm mb-4 leading-relaxed">
                  If you&apos;re reading this while navigating your own
                  challenges, know that your feelings are completely valid and
